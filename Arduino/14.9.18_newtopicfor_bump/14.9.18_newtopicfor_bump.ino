...
long int averageFrontBlack[8] = {1720 , 1769 , 1823 , 2669 , 1985 , 2156 , 2469 , 2767   };
long int averageFrontWhite[8] = {1088  , 1020  , 977  , 1151  , 952  , 1029  , 1189  , 1329   };
long int averageBackBlack[8] = {3069 , 3068 , 3068 , 3068 , 3063 , 2986 , 3063 , 3063 };
long int averageBackWhite[8] = {431 , 599 , 653 , 218 , 525 , 181 , 1298 , 1440};
int bumpswitch = 0;
